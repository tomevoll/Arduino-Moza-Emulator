...
void drawDecodedEventLog() {
  ...
  textAlign(LEFT, TOP);
  textSize(14);
  text("Promiscuous Decoded I2C Bus Traffic (Microsecond Timestamps, All Hex Addresses & Data):", logX + 15, logY + 12);
